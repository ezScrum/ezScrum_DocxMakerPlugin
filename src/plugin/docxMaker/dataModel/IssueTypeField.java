...
public class IssueTypeField {
	...
	private void decideCategory(String category) {
		...
		else if (category.equals("Textbox")) this._category = Category.Textbox;
		else if (category.equals("Textarea")) this._category = Category.Textarea;
		else if (category.equals("Number")) this._category = Category.Number;
		else if (category.equals("Textbox")) this._category = Category.Date;
	}
